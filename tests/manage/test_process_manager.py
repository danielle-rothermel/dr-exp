...
class TestProcessManager:
    ...
    def test_interface_methods_exist(self):
        ...
        assert hasattr(manager, 'stop_all_workers') and callable(manager.stop_all_workers)
        assert hasattr(manager, 'restart_worker') and callable(manager.restart_worker)
        assert hasattr(manager, 'get_worker_count') and callable(manager.get_worker_count)
        assert hasattr(manager, 'get_worker_status') and callable(manager.get_worker_status)
