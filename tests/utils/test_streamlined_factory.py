...
class TestSystemConfig:
    ...
    def test_gpu_discovery_default(self):
        ...
        with patch.dict('os.environ', {"EXPMGR_MODE": "files_local", "DR_EXP_BASE_PATH": "/tmp"}, clear=True):
            config = SystemConfig()
    ...
    def test_validation_low_heartbeat_timeout(self, temp_config):
        ...
        with pytest.raises(ValueError, match="heartbeat_timeout must be at least 10 seconds"):
            temp_config.validate()
    ...
    def test_validation_low_worker_heartbeat_interval(self, temp_config):
        ...
        with pytest.raises(ValueError, match="worker_heartbeat_interval must be at least 0.1 seconds"):
            temp_config.validate()
    ...
    def test_validation_heartbeat_interval_vs_timeout(self, temp_config):
        ...
        with pytest.raises(ValueError, match="worker_heartbeat_interval must be less than heartbeat_timeout"):
            temp_config.validate()
