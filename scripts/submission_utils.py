...
class SubmissionLogger:
    ...
    def log_submission(self, config: str, seed: int, job_id: str, success: bool, error: Optional[str] = None):
...
class JobSubmitter:
    ...
    def print_summary(self):
        ...
        if self.failed_jobs:
            ...
            failed_configs = sorted(set((j['config'], j['seed']) for j in self.failed_jobs))
