#!/usr/bin/env python3
"""Analyze correlations between regression fit metrics and best validation accuracy.
...
def create_correlation_plots(
    ...
    """Create correlation plots between regression metrics and best validation accuracy."""
    fig, axes = plt.subplots(3, 3, figsize=(15, 15))
    fig.suptitle("Regression Metrics vs Best Validation Accuracy", fontsize=16)
...
def main():
    parser = argparse.ArgumentParser(
        description="Analyze regression correlations using best validation accuracy"
    )
    parser.add_argument(
    ...
    # Save summary
    summary_path = output_dir / "regression_analysis_summary_best_acc.csv"
    df.to_csv(summary_path, index=False)
    print(f"\nSaved summary to {summary_path}")

    # Create plots with labels
    plot_path_labeled = (
        output_dir / "regression_correlation_analysis_best_acc_labeled.png"
    )
    ...
    plot_path_unlabeled = (
        output_dir / "regression_correlation_analysis_best_acc_unlabeled.png"
    )
